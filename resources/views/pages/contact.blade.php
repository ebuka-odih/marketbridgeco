            ...
            <div class="inner">
                <div class="tableBox">
                    <div class="table_cellBox">
                        <div class="text_box">
                            <h2>Contact Cotrad</h2>
                            <h3>Need to Get in Touch with Cotrad？</h3>
        ...
        <div class="page_content">
            <div class="inner">
                <div class="page_top_text">
                    <h2><strong>Contact</strong> Cotrad</h2>
                ...
                <div class="contact_us_adderss">
                    ...
                    <div class="address_box right">
                        <div class="address_box_height">
                            <h3>New to Cotrad？</h3>
                            <p>To open a Cotrad account, please <a href="register" class="content_us_a">click here</a> . For any queries related to account opening, please contact us 9am - 5pm Monday - Friday</p>
