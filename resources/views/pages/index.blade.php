                    ...
                    <div class="inner">
                        <div class="tableBox">
                            <div class="table_cellBox">
                                <div class="text_box">
                                    <h2>Access to an automated trading system, Commodities from Cotrad</h2>
...
<div class="home_content">
        ...
        <div class="inner">
            <div class="home_row2_content">
                <div class="text_box">
                    ...
                    <p>Cotrad is a <strong><a href="index.php/home/regulation.html">regulated</a></strong>  broker, providing traders with access to the global market through top tier FX liquidity providers.</p>
                    <p>With Cotrad, you will experience super-fast trade execution, as well as interbank grade, RAW ECN spreads.  When combined, these elements offer clients a true institutional trading experience, across a wide range of trading instruments.</p>
                    <h3>Gain YOUR trading advantage with Cotrad.</h3>
                </div>
    ...
    <div class="home_row3">
        <div class="inner">
            ...
            <div class="text_box">
                ...
                <p>Experience the difference with Cotrad today.</p>
            ...
            <div class="home_row5_left">
                ...
                <!-- <div class="home_row5_video">
                    <div class="home_row5_video_box video_left">
                        ...
                        <p>
                          <img class="video_play" src="https://traderscorp.io/assets/home/wp-content/themes/vfx_new/images/home_row5_video_youtube.png" alt=""> LIVE ON Cotrad TV
                        </p>
                        <h6>Cotrad News</h6>
                    </div>
    ...
    <div class="home_row6">
        <div class="inner">
            <h2>trade your way <strong>with Cotrad</strong></h2>
    ...
    <div class="home_row8">
        <div class="inner">
            <h2 class="page_title_center">Switch to Cotrad Today and <strong>Experience the Difference</strong></h2>
            <ul class="home_three_rows">
                <li>
                    <div class="home_three_rows_box">
